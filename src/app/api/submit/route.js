...
export async function POST(request) {
  try {
    ...
    const insertQuery = `
      INSERT INTO "affiliate-world-dubai-lottery"
    ...
    const adminEmailBody = makeBody(
      ...
      process.env.EMAIL_USER,
      "New Affiliate World Dubai Lottery Entry",
      `
    ...
    const clientEmailSubject =
      "Affiliate World Dubai Participation Confirmation Letter";
    ...
    <tbody>
        <tr>
            <td style="padding: 50px 40px 16px 40px; color:#0A0A0A;">
                ...
                font-style: normal;
                font-weight: 400;
                line-height: normal;">You've successfully registered for the Clarity Global Raffle at Affiliate World Dubai! You now have the opportunity to win great gifts.</p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="padding: 16px 40px;">
                ...
                <ul style="font-size: 10px;color: #2D2D2D;padding-left: 12px;">
                    <li>The raffle will take place at our booth during the event at Affiliate World Dubai 2025</li>
                    <li>If you win, you will receive a personal email notification with instructions on how to claim your prize.</li>
                </ul>
            </td>
        </tr>
        <tr>
...
padding: 32px;">
                ...
                line-height: normal;margin: 0;">For real-time updates and raffle results,<br>
                        ...
                        <a href="https://t.me/+yQGYniRsLHNiMDM8" target="_blank" style="color: #FFF;
                        font-size: 10px;
                        font-style: normal;
                        font-weight: 700;
                        line-height: 1;
        ...
        <tr>
            <td style="padding: 16px 40px 40px 40px;">
                ...
                font-weight: 400;
                line-height: normal;
                margin-bottom: 24px;">Thank you for participating, and good luck! We look forward to seeing you at the event.</p>
                <p style="color: #2D2D2D;
                font-size: 12px;
                font-style: normal;
                font-weight: 800;
